...
class Helper:
    ...
    def execute_action(self, action, action_params):
        ...
        :param action: an str representing the action to perform. This action is a valid action as defined in the action_config.json file.
        :type action: str
        :param action_params: a dictionary representing the parameters associated with the action as defined in the action_config.json file.
